...
// 1.1.X. Gestionar perfil de usuario (Falta)
void static gestionarPerfilUsuario(string idUsuario) {
	int opcion;
	do {
		system("cls");
		std::cout << "||=================================================||" << std::endl;
		...
		case 1:
			system("cls");
			if (idUsuario[0] == 'A') {
				auto administrador = supermercado.getAdministradores().buscar(
					[idUsuario](const Administrador<string, float>& admin) {
						return (admin.getIdAdministrador() == idUsuario);
					});
				std::cout << "||=================================================||" << std::endl;
				...
				std::cout << "||=================================================||" << std::endl;
				if (ver == 'S' || ver == 's') {
					std::cout << "|| Interacción activada." << std::endl;
					std::cout << "||=================================================||" << std::endl;
					regresando(3);
				}
				else {
					std::cout << "|| Interacción desactivada." << std::endl;
					std::cout << "||=================================================||" << std::endl;
					regresando(3);
				}
			}
			else if (idUsuario[0] == 'C') {
				auto cliente = supermercado.getClientes().buscar(
					[idUsuario](const Cliente<string, float>& cli) {
						return (cli.getIdCliente() == idUsuario);
					});
				std::cout << "||=================================================||" << std::endl;
		...
		case 2:
			...
			std::cout << "||-------------------------------------------------||" << std::endl;
			system("pause>0");
			break; // Implementar modificar mi perfil
...
// 1.1. Menu iniciar sesión y dashboard del usuario (Falta)
void static dashboardUsuario(string idUsuario) {
	int opcion = 0;
	do {
		system("cls");
		std::cout << "||=================================================||" << std::endl;
		if (idUsuario[0] == 'A') {
			...
			case 5: gestionarPerfilUsuario(idUsuario); break;
